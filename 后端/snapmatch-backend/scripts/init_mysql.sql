CREATE DATABASE IF NOT EXISTS snapmatch DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE snapmatch;
SET NAMES utf8mb4;
...
SELECT 'SnapMatch database initialized successfully.' AS message;
