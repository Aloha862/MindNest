  ...
  <main class="landing">
    ...
    <section class="hero">
      <div class="hero-grid page-shell">
        <div class="hero-copy">
          <span class="eyebrow"><Sparkles />AI 学习空间助手</span>
          <h1>智学空间(MindNest)<br />把学习过程形成闭环</h1>
          <p>
            通过 OpenCV 图像预处理、YOLO 区域检测、OCR 公式识别、视觉语言模型理解和专注监督，
            把题目、错因、学习状态整理成可复盘的个性化报告。
          </p>
          <div class="actions">
    ...
    <section class="cta page-shell">
      <ShieldCheck />
      <h2>进入你的 AI 学习空间</h2>
      <p>上传题目、开启专注监督，并在学习报告中看到下一步复习方向</p>
      <div>
